...
class ExpungeTest(unittest.TestCase):
    ...
    def test_expunge(self):
        ...
        self.assertTrue(
            os.path.join(workdir, "bzr.mfd-consult.dk,2007,venus-expunge-test1,1")
            in files
        )
        self.assertTrue(
            os.path.join(workdir, "bzr.mfd-consult.dk,2007,venus-expunge-test2,1")
            in files
        )
        self.assertTrue(
            os.path.join(workdir, "bzr.mfd-consult.dk,2007,venus-expunge-test3,3")
            in files
        )
        self.assertTrue(
            os.path.join(workdir, "bzr.mfd-consult.dk,2007,venus-expunge-test4,2")
            in files
        )
        self.assertTrue(
            os.path.join(workdir, "bzr.mfd-consult.dk,2007,venus-expunge-test4,3")
            in files
        )
